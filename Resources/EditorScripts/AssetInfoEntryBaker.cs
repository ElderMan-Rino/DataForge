...
{
	public static class AssetInfoEntryBaker
	{
		private static List<AssetInfoEntry> ParseDto(string sourcePath)
		{
		...
		public static void Bake_AssetInfoEntryPreload(string sourcePath, string savePath, byte[] encryptionKeyPartB)
		{
			var dtoList = ParseDto(sourcePath);
