...
{
	public static class BlobTestSheetEditorDataParser
	{
		public static BlobTestSheetEditorData ParseRow(List<string> rowData)
		{
			...
			return new BlobTestSheetEditorData(id, key, value);
		}
	}
}
